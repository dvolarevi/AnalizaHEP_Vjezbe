...
// Wed Nov 24 11:49:25 2021 by ROOT version 6.24/06
// from TTree tree/tree
// found on file: /home/public/data/ElectronTraining/train.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/public/data/ElectronTraining/train.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/public/data/ElectronTraining/train.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/home/public/data/ElectronTraining/train.root:/ntuplizer");
