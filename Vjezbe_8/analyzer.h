...
// Wed Nov 10 11:56:04 2021 by ROOT version 6.24/04
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void PlotHistogram(TString putanja);
   virtual void FillCanvass();
   virtual void Fullpod();
};
...
{
	//zad1
   histo1 = new TH1F("h1", "mass", 100, 110, 150);
   histo2 = new TH1F("h2", "mass", 100, 110, 150);
   kvadratna = new TF1("kvadratna", "[0]+[1]*x+[2]*x*x", 110, 150);
   bw = new TF1("bw", "[0]*[1]/((x*x-[2]*[2])*(x*x-[2]*[2])+0.25*[1]*[1])", 110, 150);
   zbroj = new TF1("zbroj","[0]+[1]*x+[2]*x*x+[3]*[4]/((x*x-[5]*[5])*(x*x-[5]*[5])+0.25*[4]*[4])",110,150);
   
	kvadratna->SetParNames("a", "b", "c");
	bw->SetParNames("d", "#Gamma", "M");
	zbroj->SetParNames("a", "b", "c", "d", "#Gamma", "M");
	kvadratna->SetParameters(10, -0.2, 5e-04);
	bw->SetParameters(2600, 820, 125);
	zbroj->SetParameters(10, -0.2, 5e-04, 2600, 820, 125);
	
	
   //zad2
   histo3 = new TH1F("h3", "masa", 200, 70, 170);
   histo4 = new TH1F("h4", "h4", 200, 70, 170);
   mh = new TF1("mh","[0]+[1]*x+[2]*x*x + [3]*[4]/((x*x-[5]*[5])*(x*x-[5]*[5])+0.25*[4]*[4])+[6]*[7]/((x*x-[8]*[8])*(x*x-[8]*[8])+0.25*[7]*[7])",70.0,170.0);
   mh->SetParNames("A", "B", "C", "D_{Higgs}", "#Gamma_{Higgs}", "M_{Higgs}", "D_{Z}", "#Gamma_{Z}", "M_{Z}");
   mh->SetParameters(-2.789, 0.04629, -0.0001112, 2720.0, 866.4, 124.5, 4737.0, 737.3, 90.83);
