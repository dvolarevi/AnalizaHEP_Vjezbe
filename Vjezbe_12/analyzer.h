...
// Thu Jan 13 10:42:35 2022 by ROOT version 6.24/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TH1F *hs_ele_pt; 
   TH1F *hs_scl_eta;
   TH1F *hs_ele_hadronicOverEm; 
   TH1F *hs_ele_gsfchi2;
   TH1F *hs_ele_fbrem;
   TH1F *hs_ele_ep;
   TH1F *hs_ele_eelepout;
   TH1F *hs_ele_pfChargedHadIso;
   //pozadinski
   TH1F *hb_ele_pt;
   TH1F *hb_scl_eta;
   TH1F *hb_ele_hadronicOverEm;
   TH1F *hb_ele_gsfchi2;
   TH1F *hb_ele_fbrem;
   TH1F *hb_ele_ep;
   TH1F *hb_ele_eelepout;
   TH1F *hb_ele_pfChargedHadIso;
};
...
//signal
hs_ele_pt = new TH1F("ele_pt_s","",100,0,100);
hs_scl_eta = new TH1F("scl_eta_s","",100,-5,5);
hs_ele_hadronicOverEm = new TH1F("ele_hadronicOverEm_s","",100,-1,3);
hs_ele_gsfchi2 = new TH1F("ele_gsfchi2_s","",100,-1,30);
hs_ele_fbrem = new TH1F("ele_fbrem_s","",100,-2,2);
hs_ele_ep = new TH1F("ele_ep_s","",100,-1,20);
hs_ele_eelepout = new TH1F("ele_eelepout_s","",100,-1,15);
hs_ele_pfChargedHadIso = new TH1F("ele_pfChargedHadIso_s","",100,-1,50);
//background
hb_ele_pt = new TH1F("ele_pt_b","",100,0,100);
hb_scl_eta = new TH1F("scl_eta_b","",100,-5,5);
hb_ele_hadronicOverEm = new TH1F("ele_hadronicOverEm_b","",100,-1,3);
hb_ele_gsfchi2 = new TH1F("ele_gsfchi2_b","",100,-1,30);
hb_ele_fbrem = new TH1F("ele_fbrem_b","",100,-2,2);
hb_ele_ep = new TH1F("ele_ep_b","",100,-1,20);
hb_ele_eelepout = new TH1F("eele_eelepout_b","",100,-1,15);
hb_ele_pfChargedHadIso = new TH1F("ele_pfChargedHadIso_b","",100,-1,50);
